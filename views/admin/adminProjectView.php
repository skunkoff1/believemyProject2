...
<body>
  ...
  <section>
    ...
    <div class="container-sm tiny">
      <form method="post" action="index.php?page=adminArticle<?php if ($mode == "edit") { ?>&mode=edit&id=<?= $id ?><?php } ?>" enctype="multipart/form-data">
        <label for="title">Titre de l'article</label>
        <input type="text" name="title" <?php if ($article != null) { ?> value="<?= $article->getTitle() ?>" <?php } ?>>
        <div id="inputDiv">
          ...
          <img id="output" src="<?php if ($article != null) { ?>ressources/images/<?= $article->getHeadImg() ?><?php } ?> ">
        </div>
        <label for="article">Contenu de l'article</label>
        <textarea id="mytextarea" name="article"><?php if ($article != null) { ?><?= $article->getContent() ?><?php } ?></textarea>
