            ...
            if ($mode == "confirmDelete") { ?>
                <div class="card" style="width:30rem;">
                    ...
                    <div class="card-footer">
                        <a href="index.php?page=adminDeleteArticle&mode=delet&id=<?= $article->getId() ?>" class="btn btn-danger">Confirmer la suppression</a>
                    </div>
                </div>
                <?php } else {
                foreach ($articleArray as $article) { ?>
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="index.php?page=adminDeleteArticle&mode=confirmDelete&id=<?= $article->getId() ?>" class="btn btn-danger">Supprimer cect article</a>
                        </div>
                    </div>
            <?php }
            } ?>
